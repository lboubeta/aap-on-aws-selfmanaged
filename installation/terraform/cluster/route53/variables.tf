...
variable "controller_external_lb_dns_name" {
  description = "External API's LB DNS name"
  type        = string
}

variable "controller_external_lb_zone_id" {
  description = "External API's LB Zone ID"
  type        = string
}

variable "controller_internal_lb_dns_name" {
  description = "Internal API's LB DNS name"
  type        = string
}

variable "controller_internal_lb_zone_id" {
